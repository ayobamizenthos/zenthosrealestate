    ...
    <nav aria-label="Pagination" className="mt-10 flex items-center justify-center gap-1.5">
      {filters.page > 1 ? (
        <Link
          ...
          className="text-ink bg-surface hover:bg-hairline flex h-11 w-11 items-center justify-center rounded-full transition-colors"
        >
            ...
            <Link
              ...
              className={
                page === filters.page
                  ...
                  : 'text-ink bg-surface hover:bg-hairline rounded-full flex h-11 min-w-11 items-center justify-center px-3 text-[14px] font-semibold transition-colors'
              }
            >
              {page}
            </Link>
