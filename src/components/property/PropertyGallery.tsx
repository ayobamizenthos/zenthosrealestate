  ...
  return (
    <>
      ...
      <button
        type="button"
        onClick={() => setLightboxIndex(0)}
        className="text-ink bg-surface hover:bg-ink mt-4 hidden h-11 items-center gap-2 rounded-full px-5 text-[14px] font-semibold transition-colors hover:text-white md:inline-flex"
      >
