...
export default async function PropertiesPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  return (
    <PropertyBrowser
      ...
      intro="We inspect every listing here and check its title document before it goes up. Filter by area, price, bedrooms, property type or title to narrow the list."
    >
      {properties.length > 0 ? (
        <>
