...
export default async function AdminBlogPage() {
  ...
  return (
    <div>
      <h1 className="text-title md:text-display text-brand font-extrabold">Blog</h1>
      <p className="text-muted mt-1.5 max-w-2xl text-[14px]">
        Articles published to the public blog. Drafts stay hidden until you tick publish.
      </p>
